...
\newcounter{bobi}
\AtBeginEnvironment{flalign*}{\setcounter{bobi}{1}}
\newcommand{\bob}[1]{
    \uncover<\value{bobi}-> {\bullet~& #1 &} 
    \stepcounter{bobi} \\
}
...
% \begin{frame}{tikz 3d coordinates}
% \centering
% \begin{tikzpicture}[scale=4]
%     \draw[thick,dashed] (0,1,0) -- (0,0,0) -- (1,0,0);
%     \draw[thick] (1,0,0) -- (1,1,0) -- (0,1,0);
...
% \newcommand{\equacao}[1]%
% {%
%     \pgfmathsetmacro\temp{(sqrt((#1)+9)-3)/((#1)*(#1))}%
%     \temp%
% }

% \begin{frame}{pgfmacro}
% \equacao{0.2}
% \end{frame}
% }
...
% % https://tex.stackexchange.com/a/504544
% \begin{frame}{Página 98, exercícios 26 e 29}
...
% \begin{flalign*}
%     \lim_{t \to 0} &\left( \frac{1}{t}-\frac{1}{t^2+t} \right) = \\
%     = \lim_{t \to 0} & \frac{t^2+t-t}{t(t^2+t)} = \\
%     = \lim_{t \to 0} & \frac{t}{t^2+t}  = \\
%     = \lim_{t \to 0} & \frac{1}{t+1} = \frac{1}{0+1} = 1 \\
% \end{flalign*}
...
%         =\lim_{t \to 0} &\frac{t-t\sqrt{1+t}}{t^2\sqrt{1+t}}=
%         \lim_{t \to 0} \frac{1-\sqrt{1+t}}{t\sqrt{1+t}}= \\
%         =\lim_{t \to 0} &\frac{1-\sqrt{1+t}}{t\sqrt{1+t}} \times \frac{1+\sqrt{1+t}}{1+\sqrt{1+t}}= \\
%         =\lim_{t \to 0} &\frac{1^2-(\sqrt{1+t})^2}{t\sqrt{1+t}(1+\sqrt{1+t})}=\\
%         =\lim_{t \to 0} &\frac{-t}{t\sqrt{1+t}(1+\sqrt{1+t})}= -\frac{1}{2}
%     \end{flalign*}
